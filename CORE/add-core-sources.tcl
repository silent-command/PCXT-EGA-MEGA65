...
set vhd_extra [list [file join $core_dir vhdl mem_bram.vhd] [file join $core_dir vhdl rom_loader.vhd] [file join $core_dir vhdl ps2_tx.vhd] [file join $core_dir vhdl vd_glue.vhd] [file join $core_dir vhdl mem_backend.vhd] [file join $core_dir vhdl analog_video_ctl.vhd] [file join $core_dir .. M2M vhdl memory avm_cache.vhd]]
