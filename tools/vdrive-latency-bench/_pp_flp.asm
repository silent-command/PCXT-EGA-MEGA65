...
wait .EQU 0x0014
exit .EQU 0x0016
chr2upper .EQU 0x0018
str2upper .EQU 0x001A
strlen .EQU 0x001C
chomp .EQU 0x001E
strcmp .EQU 0x0020
strchr .EQU 0x0022
...
divu .EQU 0x002C
divs .EQU 0x002E
chr2lower .EQU 0x0030
mulu32 .EQU 0x0032
divu32 .EQU 0x0034
split .EQU 0x0036
h2dstr .EQU 0x0038
sd_reset .EQU 0x003A
sd_r_block .EQU 0x003C
sd_w_block .EQU 0x003E
sd_r_byte .EQU 0x0040
sd_w_byte .EQU 0x0042
f32_mnt_sd .EQU 0x0044
f32_mnt .EQU 0x0046
f32_od .EQU 0x0048
f32_ld .EQU 0x004A
f32_cd .EQU 0x004C
f32_pd .EQU 0x004E
f32_fopen .EQU 0x0050
f32_fread .EQU 0x0052
f32_fseek .EQU 0x0054
gets_s .EQU 0x0056
gets_slf .EQU 0x0058
vga_init .EQU 0x005A
in_range_u .EQU 0x005C
enter .EQU 0x005E
leave .EQU 0x0060
strcpy .EQU 0x0062
strstr .EQU 0x0064
f32_fwrite .EQU 0x0066
f32_fflush .EQU 0x0068
f32_fclose .EQU 0x006A
strrplchr .EQU 0x006C
...
TABLE INCRB
                ...
                MOVE 160, R8
                MOVE R1, R9
                ASUB mulu, 1 ; R10 = 160 * spt = LBA count
                MOVE R10, R2
_TABLE_1 MOVE R1, R8
                ASUB puthex, 1
                MOVE 0x0020, R8
...
_FLP_L2C_2 ADD 1, R0 ; R = remainder + 1
                ...
                MOVE R1, R8
                AND 0xFFFB, R14 ; clear C (SHR shifts it in)
                SHR 1, R8 ; C = track / 2
                DECRB
                MOVE @R13++, R15
